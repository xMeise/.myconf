...
export ZSH="/home/xmeise/.oh-my-zsh"
...
alias c='clear'
alias rr='ranger'
alias nwboat="newsboat -u ~/.config/newsboat/urls -c ~/.config/newsboat/cache.db -C ~/.config/newsboat/config"
alias ytboat="newsboat -u ~/.config/newsboat/yturls -c ~/.config/newsboat/ytcache.db -C ~/.config/newsboat/ytconfig"
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(zsh_wifi_signal custom_os_icon ssh root_indicator dir dir_writable vcs)
